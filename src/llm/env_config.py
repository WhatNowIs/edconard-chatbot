...
from src.llm.base_config import BaseEnvConfig, MailConfig
from src.llm.db_config import DBConfig
...
class EnvConfig(ProviderConfig, BaseEnvConfig, DBConfig, MailConfig):
    """
